...
public class IndoNepalRemittanceActivity extends AppCompatActivity implements View.OnClickListener, RequestHandler, CustomInterface {
...
////                startActivity(new Intent(MainActivity.this,CameraCapture.class));
...
//                imageView.setImageBitmap(myBitmap);
    ...
    private void initialize() {
        ...
        if (list_gender.size() != 0)
            gender_spinner.setAdapter(new PaymentAdapter(IndoNepalRemittanceActivity.this, list_gender));
...
//                customDialog_Common("FUNDTRANSFER", pozo, "Select Payment Mode");
        ...
        input_mobile.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() == 10)
                    new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getSender_Validate().toString(), headerData, IndoNepalRemittanceActivity.this).execute();
                else
                    reset();
            }
        });
        ...
        adapter_doc = new ArrayAdapter<String>(IndoNepalRemittanceActivity.this,
...
//                    customDialog_Common("Fund Transfer Confirmation", object, pozo, "Sure you want to Transfer?", input_mobile.getText().toString(), input_name.getText().toString(), IndoNepalRemittanceActivity.this);
                    bene_update = false;
                    amount = "";
                }
...
//                        customReceiptNewTransaction("INDO-NEPAL BILL PAYMENT", object, IndoNepalRemittanceActivity.this);
                }
            } else if (object.getString("serviceType").equalsIgnoreCase("ADD_SENDER_DETAILS")) {
                if (object.getString("responseCode").equalsIgnoreCase("200")) {
                    otpRefId = object.getString("otpRefId");
//                    if (otp_flag)
////                        customDialog_Common("OTPLAYOUT", null, null, "Add Sender Details", null, null, IndoNepalRemittanceActivity.this);
//                    else {
                        new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getSender_Validate().toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                        if (object.has("senderDetails")) {
                        delete_all.setVisibility(View.VISIBLE);
...
//                    otpView.requestFocus();
                ...
                if (object.getString("responseCode").equalsIgnoreCase("200")) {
                    ...
                    nepalDistrict = "";
                    if (bene_update)
                        new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getServiceFee(amount, paymode).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                    else
//                        customDialog_Common("KYCLAYOUTS", null, null, null, null, object.getString("responseMessage"), IndoNepalRemittanceActivity.this);
                }
                ...
                if (object.getString("responseCode").equalsIgnoreCase("200")) {
//                    customDialog_Common("KYCLAYOUTS", null, null, "INDO-NEPAL Remittance", "", object.getString("responseMessage"), IndoNepalRemittanceActivity.this);
                }
            }
//            hideKeyboard(IndoNepalRemittanceActivity.this);
        } catch (
                Exception e)
    ...
    private void getDistrict(JSONArray array) {
        ...
        if (nepalDistrictPozoArrayList.size() != 0)
            bank_district.setAdapter(new NepalDistrictAdapter(IndoNepalRemittanceActivity.this, nepalDistrictPozoArrayList));
    }
    ...
    private void getCity(JSONArray array) {
        ...
        if (nepalCityPozoArrayList.size() != 0) {
            nepalCityAdapter = new NepalCityAdapter(IndoNepalRemittanceActivity.this, nepalCityPozoArrayList);
...
//                customSpinner((TextView) findViewById(R.id.select_state), "Select State", list_state);
            ...
            case R.id.btn_submit:
                if (input_name.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(IndoNepalRemittanceActivity.this, "Please Select document type", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(IndoNepalRemittanceActivity.this, "Please Select Gender", Toast.LENGTH_SHORT).show();
                } else {
                    new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, addSenderDetails().toString(), headerData, IndoNepalRemittanceActivity.this).execute();
                }
                break;
        }
    }
...
//        setBack_click(this);
    ...
    public void okClicked(String type, Object ob) {
        if (type.equalsIgnoreCase("Fund Transfer Confirmation")) {
            new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getMoneyTransferPMT(input_amountss.getText().toString(), paymode, pozo).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
        } else if (type.equalsIgnoreCase("OTPLAYOUT")) {
//            if (!otpView.getText().toString().isEmpty()) {
//                new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getOtpPMT(otpView.getText().toString()).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                otp_flag = false;
//            }
...
//                    image.requestFocus();
//                } else {
//                    new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, docUpload(ob.getUserTxnId()).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                    newdialog.dismiss();
//                }
//            }
//        });
...
//                    bank_selectss.setAdapter(new PaymentAdapter(IndoNepalRemittanceActivity.this, list_payment));
...
//                if (list_bank.size() != 0)
//                    bank_name.setAdapter(new PaymentAdapter(IndoNepalRemittanceActivity.this, list_bank));
...
//                    account_type.setAdapter(new PaymentAdapter(IndoNepalRemittanceActivity.this, list_account_type));
//                bank_name.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
//                    @Override
//                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
//                        if (position != 0) {
//                            nepalBank = list_bank.get(position).getTypeID();
//                            new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getNepalDistrict(nepalBank).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
...
//                            new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getNepalCity(nepalBank, nepalDistrict).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                        } else
//                            nepalDistrict = "";
//                    }
//
...
//                    Toast.makeText(IndoNepalRemittanceActivity.this, "Please select payment mode", Toast.LENGTH_SHORT).show();
...
//                    new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, getServiceFee(input_amountss.getText().toString(), paymode).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                    alertDialog.dismiss();
...
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Please select bank", Toast.LENGTH_SHORT).show();
//                    else if (nepalDistrict.equalsIgnoreCase(""))
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Please select district", Toast.LENGTH_SHORT).show();
//                    else if (branchID.equalsIgnoreCase(""))
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Please select city", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Please Select Account Type", Toast.LENGTH_SHORT).show();
...
//                        new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, addBene(ob.getReceiver_Mobile(), split[0], split[1], split[2], ob.getRelation_With_Sender(), "U", branchID, accountno.getText().toString(), confirmAccountNo.getText().toString(), ob.getPmt_Bene_Id(), accountType).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
//                        bene_update = true;
//                        amount = input_amountss.getText().toString();
//                        alertDialog.dismiss();
//                    } else
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Account number not match", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//        btn_cancel.setOnClickListener(new View.OnClickListener() {
...
//                final ArrayList<PaymentModePozo> list_payment = BaseCompactActivity.db.getBankNepal();
//                if (list_payment.size() != 0)
//                    bank_name.setAdapter(new PaymentAdapter(IndoNepalRemittanceActivity.this, list_payment));
//                final ArrayList<PaymentModePozo> list_account_type = new ArrayList<>();
//                list_account_type.add(new PaymentModePozo("0", "Select Account Type"));
//                list_account_type.add(new PaymentModePozo("1", "SAVING"));
//                list_account_type.add(new PaymentModePozo("2", "CURRENT"));
...
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Please Select Account Type", Toast.LENGTH_SHORT).show();
//                    else if (accountno.getText().toString().equalsIgnoreCase(confirmAccountNo.getText().toString())) {
//                        new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, addBene(bene_number.getText().toString(), bene_name.getText().toString(), bene_city.getText().toString(), bene_address.getText().toString(), bene_relation.getText().toString(), "I", branchID, accountno.getText().toString(), confirmAccountNo.getText().toString(), "", accountType).toString(), headerData, IndoNepalRemittanceActivity.this).execute();
////                        alertDialog.dismiss();
//                    } else
//                        Toast.makeText(IndoNepalRemittanceActivity.this, "Account number not match", Toast.LENGTH_SHORT).show();
//                } else {
//                    new AsyncPostMethod(WebConfig.PMTSERVICE_DETAILS, addBene(bene_number.getText().toString(), bene_name.getText().toString(), bene_city.getText().toString(), bene_address.getText().toString(), bene_relation.getText().toString(), "I", branchID, "", "", "", "").toString(), headerData, IndoNepalRemittanceActivity.this).execute();
////                    alertDialog.dismiss();
//                }
//            }
//        });
