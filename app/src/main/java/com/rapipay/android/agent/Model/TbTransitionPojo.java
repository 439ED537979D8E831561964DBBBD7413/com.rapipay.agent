...
public class TbTransitionPojo extends RealmObject {
    @PrimaryKey
    private String operatorsId;
    private String operatorsValue;
    private String operatorsData;

    public TbTransitionPojo(String operatorsId, String operatorsValue) {
        this.operatorsId = operatorsId;
        this.operatorsValue = operatorsValue;
    }

    public TbTransitionPojo() {
    }

    public TbTransitionPojo(String operatorsData) {
