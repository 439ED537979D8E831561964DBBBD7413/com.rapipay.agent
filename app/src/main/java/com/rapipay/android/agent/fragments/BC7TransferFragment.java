 ...
 */
public class BC7TransferFragment extends BaseFragment implements View.OnClickListener, WalletRequestHandler, CustomInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = inflater.inflate(R.layout.fragment_bc7_transfer, container, false);
        localStorage = LocalStorage.getInstance(getActivity());
        heading = (TextView) getActivity().findViewById(R.id.toolbar_title);
        if (balance != null)
            heading.setText("BC7 Fund Transfer (Balance : Rs." + balance + ")");
        else
            heading.setText("BC7 Fund Transfer");
        ...
        trans_details.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), trans_details, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (transactionPozoArrayList.size() != 0 && !receipt_clicked) {
                    ...
                    new WalletAsyncMethod(WebConfig.WALLETRECEIPTURL, receipt_request(pozo).toString(), headerData, BC7TransferFragment.this, getActivity(), getString(R.string.responseTimeOutTrans), "BCTRANSFER").execute();
                }
            }
    ...
    /*  {"serviceType":"Verify_Mobile","prevServiceType":"ADD_SENDER_DETAILS","otp":"213195","otprefID":"602900020298","fundTransferId":"19090706435415068",
              "transactionID":"19090706440849973","senderMobile":"9222222222","nodeAgentId":"1000000014","requestType":"BC_CHANNEL","typeMobileWeb":"WEB","reqFor":"BC7","txnIP":"172.16.50.73","sessionRefNo":"NZ794ZM3HG"}
  */
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_sender:
                ...
                if (!input_name.getText().toString().isEmpty())
                    new WalletAsyncMethod(WebConfig.BC7RemittanceApp, addSender().toString(), headerData, BC7TransferFragment.this, getActivity(), getString(R.string.responseTimeOutTrans), "BCTRANSFER").execute();
                else
            ...
            case R.id.btn_otpsubmit:
                ...
                if (!otpRefId.isEmpty() && !fund_transferId.isEmpty() && !input_otp.getText().toString().isEmpty()) {
                    hideKeyboard(getActivity());
                    new WalletAsyncMethod(WebConfig.BC7RemittanceApp, add_OtpDetails(otpRefId, fund_transferId).toString(), headerData, BC7TransferFragment.this, getActivity(), getString(R.string.responseTimeOutTrans), "BCTRANSFER").execute();
                } else
                    ...
                    if (object.getString("serviceType").equalsIgnoreCase("ADD_SENDER_DETAILS") && object.has("otpRefId")) {
                        ...
                        if (object.has("getTxnReceiptDataList")) {
                            try {
                                ...
                                customReceiptNew("Money Transfer", object, BC7TransferFragment.this);
                            } catch (Exception e) {
                                e.printStackTrace();
            ...
            public void onClick(View v) {
                ...
                if (type.equalsIgnoreCase("Fund Transfer")) {
                    if (!ImageUtils.commonAmount(ben_amount.getText().toString())) {
                        ...
                        transfer_type = input;
                        new WalletAsyncMethod(WebConfig.BC7RemittanceApp, service_fee(ben_amount.getText().toString(), "DMT_BC_AC_TRANSFER").toString(), headerData, BC7TransferFragment.this, getActivity(), getString(R.string.responseTimeOutTrans), "BCTRANSFER").execute();
                        dialog.dismiss();
                    }
                }
                listitem_click = true;
        ...
        try {
            if (type.equalsIgnoreCase("Fund Transfer Confirmation")) {
                ...
                if (type.equalsIgnoreCase("Fund Transfer Details"))
                    customReceiptNew(type, object, BC7TransferFragment.this);
                else {
