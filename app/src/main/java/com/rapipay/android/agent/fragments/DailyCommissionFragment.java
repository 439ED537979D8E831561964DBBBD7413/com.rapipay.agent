...
public class DailyCommissionFragment extends BaseFragment implements RequestHandler {
    ...
    private void loadApi() {
        new AsyncPostMethod(WebConfig.CommonReport, getNetwork_Validate(first, last).toString(), headerData,DailyCommissionFragment.this, getActivity(),getString(R.string.responseTimeOut),"D").execute();
    }
    ...
    public JSONObject getNetwork_Validate(int fromIndex, int toIndex) {
        ...
        try {
            ...
            jsonObject.put("commisionType", "D");
