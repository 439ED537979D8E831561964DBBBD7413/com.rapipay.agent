...
public class ProfileFragment extends Fragment implements RequestHandler, View.OnClickListener {
    ...
    private void loadApi() {
        new AsyncPostMethod(WebConfig.UAT, getJson_Validate().toString(), "", ProfileFragment.this, getActivity()).execute();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_login:
                ...
                new AsyncPostMethod(WebConfig.UAT, updateJson_Validate(list).toString(), "", ProfileFragment.this, getActivity()).execute();
                break;
        }
    }
