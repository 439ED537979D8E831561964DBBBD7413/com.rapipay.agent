       ...
       /* img_bc1_check = (ImageView) rv.findViewById(R.id.img_bc1_check);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.bc1id) {
                    assignBundleValue(0);
                } else if (checkedId == R.id.bc2id) {
                    assignBundleValue(1);
                }
            }
        });*/

      /*  ln_bc1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                flagdevicetype = 1;
                input_mobile.setEnabled(true);
                img_bc1_check.setVisibility(View.VISIBLE);
                img_bc2_check.setVisibility(View.GONE);
            }
        });
        ln_bc2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                flagdevicetype = 2;
                input_mobile.setEnabled(true);
                img_bc1_check.setVisibility(View.GONE);
