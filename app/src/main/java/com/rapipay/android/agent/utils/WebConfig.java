...
public class WebConfig {
    ...
    public static String CASHOUT_URL_NEW = WEBMain + "AEPS_GATEWAY_V2/AepsServiceApi";
    ...
    public static String BC2RemittanceApp = KYCACT + "DMTBC2ALAPP/BC2ALService";
    public static String BC6RemittanceApp = KYCACT + "DMTBC6APP/BC6AService";
    public static String BC7RemittanceApp = WEBMain + "DMTBC7APP/BC7AapService";
    // public static String BC6RemittanceApp = "http://172.16.50.73:8080/DMTBC6APP/BC6AService";
    public static String BC2DMTBC2Service = KYCACT + "DMTBC2ALAPP/DMTBC2Service";
    // public static String BC2DMTBC2Service =  "http://172.16.50.73:8080/DMTBC2ALAPP/DMTBC2Service";
    public static String BC6DMTBC6Service = KYCACT + "DMTBC6APP/DMTBC6Service";
    public static String BC7DMTBC7Service = WEBMain + "DMTBC7APP/DMTBC7AppService";
    public static String BC7VRIFYACCOUNT = "http://172.16.50.73:8080/DMTBC7APP/VERIFYACTBC7Service";
