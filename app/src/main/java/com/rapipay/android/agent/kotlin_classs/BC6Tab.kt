...
import com.rapipay.android.agent.fragments.BC6TransferFragment
import com.rapipay.android.agent.utils.BaseCompactActivity

class BC6Tab : BaseCompactActivity(), View.OnClickListener{

    var tabLayout: TabLayout?=null
    var fragment_credit: BC6TransferFragment?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_bc6_tab)
        bundle = Bundle()
    ...
    private fun setupTabLayout() {
        fragment_credit = BC6TransferFragment()
