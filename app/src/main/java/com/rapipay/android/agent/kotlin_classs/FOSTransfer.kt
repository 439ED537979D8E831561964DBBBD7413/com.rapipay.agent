...
//            if (amount?.equals("null")||amount!!.equals("N", ignoreCase = true))
            ...
            newtpinss = alertLayout.findViewById<View>(R.id.newtpinss) as EditText
            if (BaseCompactActivity.ENABLE_TPIN != null && BaseCompactActivity.ENABLE_TPIN.equals("Y", ignoreCase = true) && (newtpinss!!.getText().toString().isEmpty() || newtpinss!!.getText().toString().length != 4))
        ...
        btn_ok.setOnClickListener {
            if (type.equals("AMOUNTTRANSFER", ignoreCase = true)) {
                ...
                } else if (BaseCompactActivity.ENABLE_TPIN != null && BaseCompactActivity.ENABLE_TPIN.equals("Y", ignoreCase = true) && (newtpinss!!.getText().toString().isEmpty() || newtpinss!!.getText().toString().length != 4)) {
