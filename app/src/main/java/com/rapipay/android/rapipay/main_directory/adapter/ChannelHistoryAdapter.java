...
public class ChannelHistoryAdapter extends RecyclerView.Adapter<ChannelHistoryAdapter.ViewHolder> {
    ...
    public ChannelHistoryAdapter(Context context, RecyclerView recyclerView, ArrayList<ChannelHistoryPozo> items) {
        mValues = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.channel_history_adapter, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.btn_p_amounts.setText(mValues.get(position).getAccount());
        holder.btn_name.setText(mValues.get(position).getName());
        holder.p_transid.setText(mValues.get(position).getAmount());
        holder.btn_p_bank.setText(mValues.get(position).getTxnId());
